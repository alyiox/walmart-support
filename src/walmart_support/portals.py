...
(``00D61000000ZKTc`` and ``00DE0000000ZuEH``) running the same custom app --
...
case filed end to end on Sam's Club (00019047).
...
SAMSCLUB = Portal(
    ...
    # Confirmed by filing case 00019047 through this CLI: openCase is accepted,
